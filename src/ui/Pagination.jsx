...
function Pagination({ resultsCount }) {
  ...
  const numOfPages = Math.ceil(resultsCount / PAGE_SIZE);
  ...
  function handleNext() {
    searchParams.set("page", currentPage !== numOfPages ? currentPage + 1 : currentPage);
    setSearchParams(searchParams);
  }
  ...
  return (
    <StyledPagination>
      <P>
        ...
        <span>{currentPage === numOfPages ? resultsCount : currentPage * PAGE_SIZE}</span> of{" "}
      ...
      <Buttons>
        ...
        <PaginationButton onClick={handleNext} disabled={currentPage === numOfPages}>
